# Lab8 Use streamlit to run RAG_LLM Q&A, use streaming output base one Lab7-LlamaIndex_CUM_ST.py

# Usage: At the dir of it and run the command "streamlit run ./Lab8-LlamaIndex_CUM_ST_Streaming.py"
...
# Set ollama model
Settings.llm = Ollama(model="llama3", request_timeout=200.0, temperature=0.6)
